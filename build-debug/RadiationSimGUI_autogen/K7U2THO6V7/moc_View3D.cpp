...
#include <memory>
#include "../../../include/visualization/View3D.h"
...
#define QT_MOC_LITERAL(ofs, len) uint(sizeof(qt_meta_stringdata_View3D_t::offsetsAndSizes) + ofs), len
Q_CONSTINIT static const qt_meta_stringdata_View3D_t qt_meta_stringdata_View3D = {{
...
Q_CONSTINIT static const uint qt_meta_data_View3D[] = {
...
Q_CONSTINIT const QMetaObject View3D::staticMetaObject = {
    {QMetaObject::SuperData::link<QOpenGLWindow::staticMetaObject>(), qt_meta_stringdata_View3D.offsetsAndSizes,
     qt_meta_data_View3D, qt_static_metacall, nullptr,
     qt_incomplete_metaTypeArray<qt_meta_stringdata_View3D_t,
                                 // Q_OBJECT / Q_GADGET
